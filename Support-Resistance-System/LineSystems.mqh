...
void Create_Horizontal_Line(string pName, double pPrice, int addColor=clrGold){
...
void Create_Vertical_Line(string pName, datetime pTime, int addColor=clrGold){
...
void Create_Trend_Line(string pName, double pPrice1, double pPrice2, datetime pTime1, datetime pTime2, int addColor=clrRed){
